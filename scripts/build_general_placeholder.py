...
This is a ONE-OFF placeholder generator, not the results builder. Once
official Nov 3 results are available as a Georgia SoS "Total Votes Results"
CSV, replace this file's output by running the real builder instead:
    python scripts/build_results_json.py <csv_path> ga-general-2026-results

Usage:
    python scripts/build_general_placeholder.py
"""
